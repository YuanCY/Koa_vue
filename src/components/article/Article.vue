<template>
  <div id="app">
    ...
    <div class="serach">
      ...
      <el-button type="primary" class="addArticle" @click="addArticle">新增</el-button>
      <!-- =============搜索================ -->
    </div>
    <div class="main">
      <!-- =============表格================ -->
      <el-table :data="articleTableData" style="width: 100%" border>
        ...
        <el-table-column label="作者" prop="authorId" width="100"></el-table-column>
        <el-table-column label="文章描述" prop="description"></el-table-column>
        <el-table-column label="是否显示" v-slot="props" width="70">
          <el-switch v-model="props.row.isShow" active-color="#13ce66" inactive-color="#ff4949"></el-switch>
        </el-table-column>
      </el-table>
      <!-- =============表格================ -->
    </div>
